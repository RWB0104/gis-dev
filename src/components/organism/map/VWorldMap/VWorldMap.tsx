/**
 * VWorld 맵 organism 컴포넌트
 *
 * @author RWB
 * @since 2023.11.20 Mon 16:08:35
 */
...
/**
 * VWorld 맵 organism 컴포넌트 반환 메서드
 *
 * @param {PropsWithChildren} param0: PropsWithChildren 객체
 *
 * @returns {ReactNode} ReactNode
 */
export default function VWorldMap({ children }: PropsWithChildren): ReactNode
{
	return (
		<MapProvider
