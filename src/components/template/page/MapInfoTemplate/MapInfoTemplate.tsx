			...
			<BasicPanel right={20} top={20}>
				<HowToPlayButton defaultOpen>
					<Stack>
						...
						<Typography variant='caption'>우측 하단의 패널은 <Typography color='primary' component='span' variant='inherit'>지도에서 자주 사용할만한 정보</Typography>를 모아 표시해주고 있습니다.</Typography>
						<br />
						...
						<Typography variant='caption'>자세한 설명은 <Link href='https://blog.itcode.dev/projects/2022/03/22/gis-guide-for-programmer-12' target='_blank'><Typography color='hotpink' component='span' fontWeight='bold' variant='inherit'>OpenLayers를 여행하는 개발자를 위한 안내서 - 12. 맵의 유용한 정보 표시하기</Typography></Link>를 참조해주세요.</Typography>
					</Stack>
				</HowToPlayButton>
			</BasicPanel>
		</SeoulMap>
