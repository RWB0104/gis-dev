			...
			<BasicPanel right={20} top={20}>
				<Stack>
					<HowToPlayButton defaultOpen>
						<Stack>
							<Typography variant='caption'>웹이나 모바일의 GPS 정보를 활용하여 자신의 위치 정보를 얻는 것을 지오로케이션이라고 합니다.</Typography>
							...
							<Typography variant='caption'><Link href='https://www.google.com/maps' target='_blank'><Typography color='hotpink' component='span' fontWeight='bold' variant='inherit'>Google Maps</Typography></Link> 또한 해당 지도와 동일하게 지오로케이션만을 이용하여 현재 위치를 표시해줍니다.</Typography>
							<br />
