				...
				<Stack>
					<HowToPlayButton defaultOpen>
						<Stack justifyContent='center'>
							...
							<Typography variant='caption'>이 페이지에선 버튼을 클릭하여 <Typography color='primary' component='span' variant='inherit'>현재 바라보는 지도 중심에 마커를 추가하는 간단한 기능을 사용</Typography>해볼 수 있습니다.</Typography>
							...
							<Typography variant='caption'>이렇게 지도 상에 표현되는 요소를 <Typography color='primary' component='span' variant='inherit'>Feature</Typography>라고 합니다.</Typography>
							<Typography variant='caption'>Feature들은 상호작용이 가능한 객체로, 클릭 이벤트와 같은 다양한 상호작용을 할 수 있습니다.</Typography>
							<br />

							<Typography variant='caption'>자세한 설명은 <Link href='https://blog.itcode.dev/projects/2022/04/04/gis-guide-for-programmer-14' target='_blank'><Typography color='hotpink' component='span' fontWeight='bold' variant='inherit'>OpenLayers를 여행하는 개발자를 위한 안내서 - 14. 지도에 사용자의 위치 표시하기</Typography></Link>를 참조해주세요.</Typography>
						</Stack>
					</HowToPlayButton>
